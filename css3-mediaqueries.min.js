...
""},0);setTimeout(function(){cssHelper.broadcast("cssMediaQueriesTested")},100)}else cssHelper.broadcast("cssMediaQueriesTested")},w=function(){for(var f=0;f<q.length;f++)cssHelper.removeStyle(q[f]);q=[];cssHelper.mediaQueryLists(r)},m=0,s=function(){var f=cssHelper.getViewportWidth(),h=cssHelper.getViewportHeight();if(ua.ie){var a=document.createElement("div");a.style.width="100px";a.style.height="100px";a.style.position="absolute";a.style.top="-9999em";a.style.overflow="scroll";document.body.appendChild(a);
m=a.offsetWidth-a.clientWidth;document.body.removeChild(a)}var c,i=function(){var a=cssHelper.getViewportWidth(),b=cssHelper.getViewportHeight();if(Math.abs(a-f)>m||Math.abs(b-h)>m){f=a;h=b;clearTimeout(c);c=setTimeout(function(){t()?cssHelper.broadcast("cssMediaQueriesTested"):w()},500)}};window.onresize=function(){var a=window.onresize||function(){};return function(){a();i()}}()},p=document.documentElement;p.style.marginLeft="-32767px";setTimeout(function(){p.style.marginTop=""},2E4);return function(){if(t())p.style.marginLeft=
"";else{cssHelper.addListener("newStyleParsed",function(f){r(f.cssHelperParsed.mediaQueryLists)});cssHelper.addListener("cssMediaQueriesTested",function(){if(ua.ie)p.style.width="1px";setTimeout(function(){p.style.width="";p.style.marginLeft=""},0);cssHelper.removeListener("cssMediaQueriesTested",arguments.callee)});i=document.createElement("div");i.style.cssText="position:absolute;top:-9999em;left:-9999em;margin:0;border:none;padding:0;width:1em;font-size:1em;";document.body.appendChild(i);if(i.offsetWidth!==
16)i.style.fontSize=16/i.offsetWidth+"em";i.style.width="";w()}s()}}());try{document.execCommand("BackgroundImageCache",!1,!0)}catch(e$$11){};